<?php
	...
	$sql = "SELECT * FROM distribuidoras WHERE id_distribuidora = '".$id."'";
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="listar-fabri.php">Distribuidor</a>
                    </li>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-user"></i>Editar Distribuidor

                    </div>

                    <div class="card-body">
                        <div class="table">
                            <form method="POST" action="../../Controller/controllerDist.php?acao=2&id=<?php echo $id ?>">
